// Small, dependency-free inline SVG icon set for the sidebar/topbar/stat cards -- avoids
// pulling in an icon library just for a dozen simple glyphs.
...
export function TagIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <Icon {...props}>
      <path d="M12.6 2H4a2 2 0 0 0-2 2v8.6a2 2 0 0 0 .6 1.4l9 9a2 2 0 0 0 2.8 0l8-8a2 2 0 0 0 0-2.8l-9-9a2 2 0 0 0-1.4-.6Z" />
      <path d="M7 7h.01" />
    </Icon>
  );
}
